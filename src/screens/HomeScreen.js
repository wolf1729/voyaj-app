...
const HomeScreen = () => {
  ...
  const recommendations = [
    ...
    },
    {
      ...
      tag: "Nature",
      image:
        "https://images.unsplash.com/photo-1517059224940-d4af9eec41b7?auto=format&fit=crop&q=80&w=400",
    },
  ];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.heroCardContainer}>
          <Card style={styles.heroCard}>
            <ImageBackground
              source={{
                uri: "https://images.unsplash.com/photo-1544735745-b89bfa94ca7e?auto=format&fit=crop&q=80&w=1000",
              }}
        ...
        >
          {upcomingTrips.map((trip) => (
            <View key={trip.id} style={styles.upcomingCardWrapper}>
              <TripCard trip={trip} showDetailsButton />
            </View>
          ))}
        </ScrollView>
